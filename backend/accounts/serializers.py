"""
Serializers for Accounts App - FIXED VERSION
"""
...
class UserRegisterSerializer(serializers.Serializer):
    ...
    phone_number = serializers.RegexField(
        regex=r"^09\d{9}$",
        error_messages={"invalid": "Phone number must be in format: 09xxxxxxxxx"},
    )
...
class ForgotPasswordSerializer(serializers.Serializer):
    """Forgot Password Serializer - NEW"""
